...
//        }
    ...
    /**
     * Makes the Session accessible from outside the package
     *
     * @return the session
     */
...
//        }
    ...
    /*
    Public to be accessible from outside the package
     */
...
//        }
    ...
    public byte[] read(int timeout) {
        ...
        for (int i = 0; i < retries; i++) {
            int tmp = mConnection.bulkTransfer(epIn, data, inMaxPS, timeout);
            if (tmp < 0) {
